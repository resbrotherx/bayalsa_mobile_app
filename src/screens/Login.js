            ...
            <View style={{justifyContent:"center",alignItems:'center',textAlign:"center",padding:-20,marginBottom:-19,marginTop:95}}>
                ...
                <View style={{flexDirection:'column',paddingTop:110}} >
                    ...
                    <View style={{flexDirection:'column',alignItems:'center',width:'95%',marginTop:60}} >
                        <TouchableOpacity onPress={()=>navigation.navigate("Payment")} style={[styles.social_btn,{backgroundColor:"#fff",width:340,marginBottom:25,borderColor:'#007ec7'}]} >
                        ...
                        <TouchableOpacity onPress={()=>alert("login in progress")} style={[styles.social_btn,{backgroundColor:"#007ec7",width:340,marginBottom:0,borderColor:'#007ec7'}]} >
